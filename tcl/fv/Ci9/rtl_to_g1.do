set log file fv/Ci9/rtl_to_g1.log -replace
...
vpx read guide file fv/Ci9/rtl_to_g1.ovf
...
add search path -library . /home/buet/cadence/EDI/tools/lib/tech
read library -statetable -liberty -both  \
	../library/stdcells.lib

add search path -design .
read design  -verilog2k -define SYNTHESIS  -golden -lastmod -noelab \
	../rtl/Ci9.v

elaborate design -golden -root Ci9 -rootonly \

read design -verilog -revised -lastmod -noelab \
	-unzip fv/Ci9/g1.v.gz

elaborate design -revised -root Ci9
...
write hier_compare dofile fv/Ci9/hier_rtl_to_g1.do \
...
run hier_compare fv/Ci9/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
